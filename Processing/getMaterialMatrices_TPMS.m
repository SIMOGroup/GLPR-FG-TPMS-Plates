...
for igp = 1:size(Wg,1)
    ...
    %Vc = Vc_lo  +  (Vc_up - Vc_lo)*(0.5+gpt/t)^n; % Vc=(1/2 + z/h)^n, n >=0
    %Vm = 1-Vc;
...
%             G_z = G_z;
    ...
    switch type_TPMS
        case 1
            E_z = E*(0.976*p_z^2.2 + 0.024);
            rho_z = rho*p_z;
        case 2
            E_z = E*(0.978*p_z^2.29 + 0.022);
            rho_z = rho*p_z;
        case 3
            E_z = E*(0.963*p_z^1.765 + 0.037);
            rho_z = rho*p_z;    
    end
    %}
