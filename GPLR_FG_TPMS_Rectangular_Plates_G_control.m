...
global G_distribution g_0 t_gpl E_gpl nu_gpl rho_gpl lambda_gpl
global porous_type
...
[Ab,Bb,Db,Eb,Fb,Hb,Ds,I]=getMaterialMatrices_G_control(material,h,imix);
...
%        plotNURBS_surf_El_CP(p,q,uKnot,vKnot,CP); 
     ...
     case 2  % Vibration
        ...
        Lamda0 = sort(Lamda0);
%         Lamda0(1)^0.25
%         Lamda0 = (Lamda0(1:6)*rhom*L^4*h/D).^0.25
